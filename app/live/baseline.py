...
from app.engines.types import MinuteBar
from app.live.session import IST, Session, get_session
...
def _cumulative_curve(day_bars: list[MinuteBar], date: dt.date, n_minutes: int) -> list[float] | None:
    """
